...
<div id="template-vehicle" class="template">
    <div class="row vehicle">
        ...
        <div class="col-xs-2 col-no-padding">
            ...
            <input type="text" placeholder="Year" class="vehicle-input">
            <input type="text" placeholder="Location" class="vehicle-input">
        </div>
        <div class="col-xs-2 col-no-padding details-input">
        </div>
        <div class="col-xs-2 col-no-padding">
        ...
        <div class="col-xs-1 col-no-padding">Status</div>
    </div>
</div>
